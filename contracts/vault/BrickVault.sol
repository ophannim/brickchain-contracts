...
/**
 * @dev Implementation of a vault to deposit funds.
 * This is the contract that receives funds and that users interface with.
 * The strategy itself is implemented in a separate 'Strategy.sol' contract.
 */
contract BrickVault is ERC20, Ownable {
    ...
    /**
     * @dev Function for various UIs to display the current value of one of our tokens.
